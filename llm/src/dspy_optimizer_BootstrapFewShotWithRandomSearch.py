...
# read openai api key from the file openai_api_key.env
...
def compile_model(model_path: str,
    ...
    compiled_module, _ = load_compiled_model(model_path)

    for _ in range(1):
        compiled_module = optimizer.compile(
            student=Text2SqlModel().activate_assertions(),
            teacher=compiled_module,
            trainset=train_set,
...
def run_gpt():
    ...
    model_path = "./dspy_models/bootstrap_few_shot_with_random_search.json"
    ...
    output_folder = "./exp_result/formula_1_dspy_bootstrapfewshotwithrandomsearch/"
